...
std::array< bool, 2> RenderTags( const std::string& uniqueKey, NamedStrings& stepVars, const std::string& attrName, Strings& currentTags, bool missingHasChanged, const std::string& hasTagLabelPre = "Tile Has", const std::string& missingTagLabelPre = "Tile Missing" );
...
std::array< bool, 2> RenderTagsOrVar( const std::string& uniqueKey, NamedStrings& stepVars, const std::string& attrName, const Strings& motifHierarchy, Strings& currentTags, bool missingHasChanged, const std::string& hasTagLabel = "Tile Has", const std::string& missingTagLabel = "Tile Missing" );
...
bool RenderCheckboxOrVar( const std::string& uniqueKey, NamedStrings& stepVars, const std::string& attrName, const Strings& motifHierarchy, bool& currentValue, const std::string& label = "", bool defaultValue = true );
...
bool RenderInputTextOrVar( const std::string& uniqueKey, NamedStrings& stepVars, const std::string& attrName, const Strings& motifHierarchy, std::string& currentText, const std::string& label = "", const std::string& defaultValue = "" );
