...
constexpr char  DATA_MAP_DEFS[]             = "Data/Gameplay/DemoMapDefs_SaveTest.xml";
...
constexpr char  EVENT_SPAWN_ACTOR[]         = "spawnActor";
constexpr char  EVENT_SPAWN_ITEM[]          = "spawnItem";
...
constexpr char  MAPGEN_ARG_TILE[]           = "callingTile";
constexpr char  MAPGEN_ARG_MAP[]            = "callingMap";
constexpr char  MAPGEN_ARG_RECALC_ALL[]     = "recalculateAll";
constexpr char  MAPGEN_ARG_ATTR_NAME[]      = "attributeName";
