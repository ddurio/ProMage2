...
// DD - Modifying Columns to expose user flags to turn off resizing
void ImGui::Columns(int columns_count, const char* id, bool border, ImGuiColumnsFlags userFlags)
{
    ImGuiWindow* window = GetCurrentWindow();
    IM_ASSERT(columns_count >= 1);

    ImGuiColumnsFlags flags = userFlags;
